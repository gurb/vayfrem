...
namespace vayfrem.views.sections
{
    public partial class ProjectTreeView : UserControl
    {
        ...
        private void setImages()
        {
            ...
            file = new Avalonia.Media.Imaging.Bitmap(AssetLoader.Open(new Uri("avares://vayfrem/assets/file.png")));
            folder = new Avalonia.Media.Imaging.Bitmap(AssetLoader.Open(new Uri("avares://vayfrem/assets/folder.png")));
        }
    }
}
